        ...
        <div class="row">
          <div class="col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <!-- <img src="assets/img/vc.jpg" class="rounded-circle"
                 style="width: 50px;height: 50px;"> -->
              <!--  <center><img src="assets/img/vc.jpg" class="rounded-circle"
                 style="width: 150px;height: 150px;">   <br>  
               </center>
               <center><h4><a href="#">Video Conferencing</a></h4></center> -->
          ...
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4><a href="#">Internet & Cloud Services</a></h4>
              <p>
