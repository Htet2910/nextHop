...
<div class="container-fluid">
        <div class="pull-right">
            <a class="btn btn-login" href="{{url('/backend/abouts')}}"> 
            <i class="fas fa-bookmark"></i> About List</a>
        </div>
        <br>
           @if ($errors->any())
             ...
             <form method="post" action="{{ route('abouts.update', $about->id) }}" enctype="multipart/form-data">
                @csrf
                 ...
                 <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="about_title" type="text" class="form-control" name="title" value="{{ $about->title }}">
                            </div>
                        </div>
                         <div class="form-group row">
                            ...
                            <label for="name" class="col-md-3">{{ __('Body') }}</label>
                              <div class="col-md-9">
                                 <textarea id="about_body" class="form-control" 
                                    name="body" 
                                    >{{ $about->body }}</textarea> 
                             </div>
                            ...
                            <label for="name" class="col-md-3">{{ __('Photo') }}</label>
                              <div class="col-md-9">
                                 <input  type="file" name="image" />
                                  <input type="hidden" name="hidden_image" value="{{ $about->image }}" />
                             </div>
